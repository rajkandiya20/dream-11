...
class PlayerManagerScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PlayerManagerScreen> createState() => _PlayerManagerScreenState();
}
...
class _PlayerManagerScreenState extends ConsumerState<PlayerManagerScreen> {
  ...
  Future<void> _loadPlayers() async {
    ...
    try {
      ...
      setState(() { _players = updated.players; _loading = false; });
    } catch (e) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.refresh, color: Color(0xFF0F172A)), onPressed: _loadPlayers),
  ...
  Widget _buildError() => Center(
    child: Padding(padding: const EdgeInsets.all(24),
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ElevatedButton(onPressed: _loadPlayers,
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (ok) { _loadPlayers(); _snack('Player added!'); }
              else _snack('Failed to add player');
            },
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (ok) { _loadPlayers(); _snack('Player updated!'); }
